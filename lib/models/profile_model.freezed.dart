...
class _$_Profile extends _Profile with DiagnosticableTreeMixin {
  _$_Profile({this.id, this.name = 'unknown', this.imgURL}) : super._();
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Profile(id: $id, name: $name, imgURL: $imgURL)';
  }
...
abstract class _Profile extends Profile {
  factory _Profile(
      {final String? id, final String name, final String? imgURL}) = _$_Profile;
  _Profile._() : super._();
